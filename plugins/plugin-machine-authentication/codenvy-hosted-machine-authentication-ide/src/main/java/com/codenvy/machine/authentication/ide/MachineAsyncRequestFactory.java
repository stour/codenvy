...
public class MachineAsyncRequestFactory extends AsyncRequestFactory {
    ...
    private final Provider<MachineTokenServiceClient> machineTokenServiceClient;
    private final DtoFactory                dtoFactory;

    @Inject
    public MachineAsyncRequestFactory(DtoFactory dtoFactory,
                                      Provider<MachineTokenServiceClient> serviceClientProvider) {
        super(dtoFactory);
        this.machineTokenServiceClient = serviceClientProvider;
    ...
    private AsyncRequest doCreateMachineRequest(RequestBuilder.Method method, String url, Object dtoBody, boolean async) {
        final AsyncRequest asyncRequest = new MachineAsyncRequest(method, url, async, machineTokenServiceClient.get());
        if (dtoBody != null) {
